...
**DiGi.Unit** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Unit.IO](DiGi.Unit.IO)** (Path: `DiGi.Unit\DiGi.Unit.IO`)
* **[DiGi.Unit](DiGi.Unit)** (Path: `DiGi.Unit\DiGi.Unit`)
